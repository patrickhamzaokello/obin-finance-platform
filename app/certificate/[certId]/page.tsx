    ...
    return (
      <div className='min-h-screen bg-[#F5F5F7] flex items-center justify-center px-4'>
        <div className='bg-white rounded-2xl shadow-sm p-10 max-w-md w-full text-center'>
          ...
          <Link href='/learn/achievements' className='inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-primary-foreground text-sm font-semibold rounded-xl hover:bg-primary/90 transition-colors'>
    ...
    <div className='min-h-screen bg-[#F5F5F7]'>
      <header className='bg-white/80 backdrop-blur-xl border-b border-black/[0.06] print:hidden'>
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex items-center gap-3'>
          <Link href='/learn/achievements' className='inline-flex items-center gap-1.5 text-sm font-medium text-muted-foreground hover:text-primary transition-colors'>
            <ArrowLeft size={14} /> Achievements
          </Link>
        </div>
      </header>
